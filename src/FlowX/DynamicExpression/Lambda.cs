...
public class Lambda
{
    ...
    public object Invoke() => InvokeWithUsedParameters([]);

    public object Invoke(params Parameter[] parameters) => Invoke((IEnumerable<Parameter>)parameters);
    ...
    internal LambdaExpression LambdaExpression(Type delegateType)
    {
        ...
        return Expression.Lambda(inferredDelegateType, Expression, parameterExpressions);
    }
}